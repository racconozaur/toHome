...
import { HiOutlineSearch, HiOutlineLocationMarker, HiOutlineMenuAlt1 } from "react-icons/hi";
        ...
        <div className=' bg-white w-full container mx-auto '>
            <div className='py-9 w-10/12 flex justify-between container mx-auto'>
                <div className="flex items-center text-lg w-full lg:w-4/12">
                    <HiOutlineSearch className="absolute ml-4" viewBox="0 0 24 24" width="24"/>
                    <Input
            ...
            <div className='w-10/12 container mx-auto flex justify-between'>
                <div className=' w-2/3 '>
                    <h2 className=' text-black text-2xl font-medium ml-10'>Results</h2>
                    { allPosts.reverse()}
                </div>
